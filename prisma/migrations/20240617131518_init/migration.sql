...
CREATE TABLE `Jobs` (
    ...
    `bountyStatus` ENUM('SUBMITTED', 'WAITING_FOR_PAYMENT', 'APPROVED', 'REJECTED') NOT NULL DEFAULT 'SUBMITTED',
    ...
    INDEX `Jobs_partnerId_idx`(`partnerId`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `Bounties` (
    ...
    INDEX `Bounties_partnerId_idx`(`partnerId`),
...
CREATE TABLE `Grants` (
    ...
    INDEX `Grants_partnerId_idx`(`partnerId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Account` (
    ...
    `providerAccountId` DOUBLE NOT NULL,
...
CREATE TABLE `User` (
    ...
    `private` BOOLEAN NOT NULL DEFAULT false,
    `skills` JSON NULL,
    `currentPartnerId` VARCHAR(191) NULL,
    ...
    INDEX `User_currentPartnerId_idx`(`currentPartnerId`),
...
CREATE TABLE `UserInvites` (
    ...
    `updatedAt` DATETIME(3) NOT NULL,
    `partnerId` VARCHAR(191) NOT NULL,
    `memberType` ENUM('PARTNER', 'MEMBER', 'ADMIN') NOT NULL DEFAULT 'MEMBER',
...
CREATE TABLE `emailLogs` (
    ...
    `type` ENUM('BOUNTY_REVIEW', 'BOUNTY_DEADLINE', 'BOUNTY_DEADLINE_WEEK', 'BOUNTY_CLOSE_DEADLINE', 'NO_VERIFICATION', 'NO_ACTIVITY', 'NO_REVIEW_PARTNER_1', 'NO_REVIEW_PARTNER_2') NOT NULL,
...
CREATE TABLE `Hackathon` (
    ...
    UNIQUE INDEX `Hackathon_partnerId_key`(`partnerId`),
    INDEX `Hackathon_partnerId_idx`(`partnerId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
